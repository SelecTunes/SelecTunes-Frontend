...
class PartyServiceImpl : PartyService {
    ...
    override fun kickGuest(givenEmail: String, activity: GuestListActivity) {
        val jsonObjectRequest = object :
            StringRequest(Method.POST, "https://coms-309-jr-2.cs.iastate.edu/api/Auth/Kick",
                Response.Listener {
    ...
    override fun getGuestList(activity: GuestListActivity, isGuest: Boolean) {
        val jsonObjectRequest = object :
            StringRequest(Method.GET, "https://coms-309-jr-2.cs.iastate.edu/api/Party/Members",
                Response.Listener {
    ...
    override fun endParty(
        activity: AppCompatActivity,
        switchedActivity: Class<out AppCompatActivity>?
    ) {
