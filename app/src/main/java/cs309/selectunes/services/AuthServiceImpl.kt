...
class AuthServiceImpl : AuthService {
    ...
    override fun login(email: String, password: String, activity: AppCompatActivity) {
        val stringRequest = object : StringRequest(
            Method.POST,
            "https://coms-309-jr-2.cs.iastate.edu/api/auth/login",
            Response.Listener {
            ...
            override fun parseNetworkResponse(response: NetworkResponse?): Response<String> {
                ...
                if (rawCookies != null) {
                    ...
                    val cookie = rawCookies.substring(
                        rawCookies.indexOf(search) + search.length,
                        rawCookies.indexOf(';')
                    )
    ...
    override fun register(
        ...
        val stringRequest = object : StringRequest(
            Method.POST,
            "https://coms-309-jr-2.cs.iastate.edu/api/auth/register",
            Response.Listener {
