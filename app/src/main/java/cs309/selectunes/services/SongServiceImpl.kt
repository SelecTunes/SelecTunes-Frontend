...
class SongServiceImpl : SongService {
    ...
    override fun searchSong(songToSearch: String, activity: SongSearchActivity) {
        ...
        val jsonObjectRequest = object : JsonObjectRequest(Method.POST,
            "https://coms-309-jr-2.cs.iastate.edu/api/Song/SearchBySong",
            json,
            Response.Listener {
    ...
    override fun addSongToQueue(song: Song, activity: AppCompatActivity) {
        ...
        val jsonObjectRequest = object : JsonObjectRequest(Method.POST,
            "https://coms-309-jr-2.cs.iastate.edu/api/Song/AddToQueue",
            json,
            null,
            Response.ErrorListener {
    ...
    override fun removeLockedSong(song: String, activity: AppCompatActivity) {
        ...
        json.put("id", song)
        val jsonObjectRequest = object : JsonObjectRequest(Method.POST,
            "https://coms-309-jr-2.cs.iastate.edu/api/Song/ThisSongWasPlayed",
            json,
            null,
            Response.ErrorListener {
