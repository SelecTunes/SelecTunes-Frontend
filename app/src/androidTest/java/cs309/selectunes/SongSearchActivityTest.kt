...
class SongSearchActivityTest {
    ...
    fun setup() {
        ...
        songList.add(
            Song(
                ...
                "Ocean Park Standoff",
                "https://i.scdn.co/image/ab67616d0000b273d33abaa87fdea5da142fd201",
                false,
                null
            )
        )
        songList.add(
            Song(
                "Good News",
                "5cInnHweXJJrRsHxwihgkK",
                "K.Flay",
                "https://i.scdn.co/image/ab67616d0000b2737f888564b247d806d838761e",
                false,
                null
            )
        )
        songList.add(
            Song(
                "Good News",
                "5sSqOGfBz5CjJ9IGL8pz31",
                "Apashe",
                "https://i.scdn.co/image/ab67616d0000b2735a1f4b77ef7a4ba35e6f7d1c",
                false,
                null
            )
        )
        songList.add(
            Song(
                "Good News",
                "3QqTmV1zpTNEAMviQFUFkW",
                "Mandisa",
                "https://i.scdn.co/image/ab67616d0000b273005a275e8a0821ab2311e33e",
                false,
                null
            )
        )
    ...
    fun testParseJson() {
        Mockito.`when`(songService.searchSong("Good News", songSearchActivity)).then {
            val fileText = this.javaClass.classLoader?.getResource("example_song_list.json")
